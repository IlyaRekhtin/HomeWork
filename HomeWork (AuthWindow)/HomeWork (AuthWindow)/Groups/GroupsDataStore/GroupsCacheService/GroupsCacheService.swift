...
final class GroupsCacheService: GroupsCacheServiceProtocol {
...
private extension GroupsCacheService {
    ...
    func getFilePath(url: String) -> String? {
        ...
        return cachesDirectory.appendingPathComponent(GroupsCacheService.pathName + "/" + hashName).path
    }
